...
export default function BannerSection() {
  return (
    <section className="relative w-full h-96 md:h-[500px] lg:h-[768px] flex items-center justify-center my-0 rounded-2xl overflow-hidden shadow-xl" data-aos="fade-up">
      <div className="absolute inset-0 w-full h-full" data-aos="zoom-in">
        <Image src="/20.jpg" alt="Special Offer Banner" fill priority style={{objectFit:'cover'}} />
      </div>
      <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-4 z-10">
        ...
        <button className="bg-yellow-400 hover:bg-yellow-300 text-black font-bold py-2 px-6 rounded-full text-base shadow-lg transition-all duration-200">Shop Sale</button>
      </div>
    </section>
  );
} 