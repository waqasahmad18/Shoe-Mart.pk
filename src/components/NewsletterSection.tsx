    ...
    <section className="w-full py-16 px-4 flex flex-col items-center justify-center bg-[#f7f7f7]" data-aos="fade-up">
      <div className="max-w-3xl w-full bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row items-center gap-8 p-8 md:p-12" data-aos="zoom-in">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 items-center justify-center md:justify-start" suppressHydrationWarning>
            <input 
              type="email" 
              required 
              ...
              className="px-4 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 w-full sm:w-64" 
            />
            <button 
              type="submit" 
              className="bg-yellow-400 hover:bg-yellow-300 text-black font-bold py-3 px-8 rounded-full text-base shadow-lg transition-all duration-200"
            >
              Subscribe
            </button>
          </form>
