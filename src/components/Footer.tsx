...
export default function Footer() {
  return (
    <footer className="w-full bg-[#111] text-gray-200 pt-14 pb-6 border-t border-gray-800 mt-0" data-aos="fade-up">
      <div className="max-w-7xl mx-auto w-full px-4 md:px-6">
        <div className="flex flex-col items-center md:items-start gap-3 max-w-xs mb-8 md:mb-0 mx-auto md:mx-0">
          ...
          <p className="text-gray-400 text-sm text-center md:text-left">Pakistan&rsquo;s premium online shoe store. Trendy, comfortable, and affordable footwear for everyone.</p>
        </div>
        <div className="grid grid-cols-2 gap-6 w-full md:flex md:flex-row md:justify-between md:items-center">
          {/* Quick Links */}
